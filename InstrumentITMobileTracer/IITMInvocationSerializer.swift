...
class IITMInvocationSerializer: NSObject {
    ...
    init(invocationOrganizer: IITMInvocationOrganizer, metricsConroller: IITMMetricsController) {
    ...
    func getDataPackage() {
        ...
        jsonObject["deviceID"] = IITMAgent.getInstance().agentProperties["id"] as! UInt64
